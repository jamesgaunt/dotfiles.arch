...
hl.config({
    ...
    decoration = {
        ...
        blur = {
            enabled = true,
            size = 4,    -- blur radius — big = dreamy
            passes = 2,  -- more passes = smoother, heavier (4 is lush)
            xray = true, -- THE effect: blur shows wallpaper through stacked windows
            new_optimizations = true,
            ignore_opacity = true,
            noise = 0.02,
            contrast = 1.1,
            brightness = 1.0,
            vibrancy = 0.2, -- saturation boost in the blur — makes it pop
            vibrancy_darkness = 0.0,
        },

        shadow = {
            enabled = true,
            range = 30, -- big soft shadows
            render_power = 4,
            color = "rgba(1a1a1aee)",
        },
    },
